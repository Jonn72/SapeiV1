...
{
	/// <summary>
	/// Clase rp_curso generada automáticamente desde el Generador de Código SII
	/// </summary>
	[Serializable]
	public partial class RP_Curso:CatalogoFijoElemento
	{
		#region Contructor
		/// <summary>
		/// Inicia una nueva instancia de la clase rp_curso.
		/// </summary>
		public RP_Curso():base()
		{
			NombreTabla = "rp_curso";
			Propietario= "dbo";
		...
		public RP_Curso(Sistema poSistema):base (poSistema)
		{
			NombreTabla = "rp_curso";
			Propietario= "dbo";
			RutaTabla = string.Format("[{0}].[{1}].[{2}]", _oSistema.Servidor.Principal.BaseDatos.Catalogo, Propietario, NombreTabla);
		...
		#region Funciones
		/// <summary>
		/// Carga un registro especifico denotado por las llaves de la tabla rp_curso.		/// </summary>
