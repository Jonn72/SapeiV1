...
{
    /// <summary>
    /// Clase rp_estado_seguimiento generada automáticamente desde el Generador de Código SII
    /// </summary>
    [Serializable]
	public partial class RP_Estado_Seguimiento:CatalogoFijoElemento
	{
        #region Contructor
        /// <summary>
        /// Inicia una nueva instancia de la clase rp_estado_seguimiento.
        /// </summary>
        public RP_Estado_Seguimiento():base()
		{
			NombreTabla = "rp_estado_seguimiento";
			Propietario= "dbo";
        ...
        public RP_Estado_Seguimiento(Sistema poSistema): base(poSistema)
		{
			NombreTabla = "rp_estado_seguimiento";
			Propietario= "dbo";
			RutaTabla = string.Format("[{0}].[{1}].[{2}]", _oSistema.Servidor.Principal.BaseDatos.Catalogo, Propietario, NombreTabla);
        ...
        /// <summary>
        /// Obtiene o establece rp_estado_seguimiento.Sin descripcion para rp_estado_seguimiento 
        /// </summary>
        /// <value>
        /// periodo
        /// </value>
        ...
        #region Funciones
        /// <summary>
        /// Carga un registro especifico denotado por las llaves de la tabla rp_estado_seguimiento.		/// </summary>
