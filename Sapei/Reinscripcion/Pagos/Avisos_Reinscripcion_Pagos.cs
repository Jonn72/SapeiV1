...
namespace Sapei
{
	...
	/// </summary>
	[Serializable]
	public partial class Avisos_Reinscripcion_Pagos : CatalogoFijoElemento
	{
		#region Contructor
		/// <summary>
		/// Inicia una nueva instancia de la clase aviso_reinscripcion_pago.
		/// </summary>
		public Avisos_Reinscripcion_Pagos() : base()
		{
			NombreTabla = "avisos_reinscripcion_pagos";
			Propietario = "dbo";
		...
		public Avisos_Reinscripcion_Pagos(Sistema poSistema) : base(poSistema)
		{
			NombreTabla = "avisos_reinscripcion_pagos";
			Propietario = "dbo";
			RutaTabla = string.Format("[{0}].[{1}].[{2}]", _oSistema.Servidor.Principal.BaseDatos.Catalogo, Propietario, NombreTabla);
		...
		/// <summary>
		/// Obtiene o establece procesado.Sin descripcion para procesado 
		/// </summary>
		/// <value>
		/// procesado 
		/// </value>
		...
		public Boolean procesado
		{
			get
			{
				return ObtenerValorPropiedad<Boolean>("procesado");
			}

			set
			{
				EstablecerValorPropiedad<Boolean>("procesado", value);
			}
		...
		protected override void CargaPropiedadesdeColumna()
		{
			...
			loColBoolean.Descripcion = "Sin descripcion para procesado";
			loColBoolean.EsIdentity = false;
			loColBoolean.Tipo = typeof(Boolean);
			AgregarPropiedad<Boolean>("procesado", loColBoolean);
