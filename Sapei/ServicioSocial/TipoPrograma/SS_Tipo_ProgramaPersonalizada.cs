...
namespace Sapei
{
	...
	/// </summary>
	public partial class SS_Tipo_Programa
	{
		#region variables
		#endregion
		#region Propiedades
        ...
        public DataTable CargaTipoProgramaSS()
        {
            StringBuilder lsQuery = new StringBuilder();
            DataTable loDt;
            lsQuery.Append(" select  id, descripcion");
            lsQuery.AppendFormat(" from ss_tipo_programa");
            lsQuery.Append(" order by descripcion asc");
        ...
        public DataTable ConsultaIdTipoPrograma(string psTipoprograma)
        {
            ...
            lsQuery.AppendFormat(" where id = '{0}' ", psTipoprograma);
            loDt = _oSistema.Conexion.RegresaDataTable(lsQuery);
            if (loDt.Rows.Count == 0)
                return null;
            return loDt;
