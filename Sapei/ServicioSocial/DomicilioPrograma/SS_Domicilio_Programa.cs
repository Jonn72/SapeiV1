...
namespace Sapei
{
	...
	/// </summary>
	[Serializable]
	public partial class SS_Domicilio_Programa:CatalogoFijoElemento
	{
		#region Contructor
		/// <summary>
		/// Inicia una nueva instancia de la clase rp_domicilio.
		/// </summary>
		public SS_Domicilio_Programa():base()
		{
			NombreTabla = "ss_domicilio_programa";
			Propietario= "dbo";
        ...
        public SS_Domicilio_Programa(Sistema poSistema)
            : base(poSistema)
		{
			NombreTabla = "ss_domicilio_programa";
			Propietario= "dbo";
		...
		#region Funciones
		/// <summary>
		/// Carga un registro especifico denotado por las llaves de la tabla ss_domicilio_programa.		/// </summary>
