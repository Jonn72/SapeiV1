...
{
    /// <summary>
    /// Clase ss_estado_solicitud generada automáticamente desde el Generador de Código SII
    /// </summary>
    [Serializable]
	public partial class SS_Estado_Solicitud:CatalogoFijoElemento
	{
        #region Contructor
        /// <summary>
        /// Inicia una nueva instancia de la clase ss_estado_solicitud.
        /// </summary>
        public SS_Estado_Solicitud():base()
		{
			NombreTabla = "ss_estado_solicitud";
			Propietario= "dbo";
        ...
        public SS_Estado_Solicitud(Sistema poSistema): base(poSistema)
		{
			NombreTabla = "ss_estado_solicitud";
			Propietario= "dbo";
			RutaTabla = string.Format("[{0}].[{1}].[{2}]", _oSistema.Servidor.Principal.BaseDatos.Catalogo, Propietario, NombreTabla);
        ...
        #region Propiedades
        /// <summary>
        /// Obtiene o establece ss_estado_solicitud.Sin descripcion para ss_estado_solicitud 
        /// </summary>
        /// <value>
        /// periodo
        /// </value>
        ...
        #region Funciones
        /// <summary>
        /// Carga un registro especifico denotado por las llaves de la tabla ss_estado_solicitud.		/// </summary>
