//Genereado de CURP
//Fuente: https://gist.github.com/Marco-Rod/4be997c5ce82afbd6452
...
function fnCalculaCURP(pstNombre, pstPaterno, pstMaterno, dfecha, pstSexo, pnuCveEntidad) {
     ...
     var AMATERNO = "";
     var T_NOMTOT = "";
     var NOMBRE1 = ""; //PRIMER NOMBRE
     var NOMBRE2 = ""; //DEMAS NOMBRES
     var NOMBRES_LONGITUD = 0; //LONGITUD DE TODOS NOMBRES
     var NOMBRE1_LONGITUD = 0; //LONGITUD DEL PRIMER NOMBRE(MAS UNO,EL QUE SOBRA ES UN ESPACIO EN BLANCO)
     var APATERNO1 = ""; //PRIMER NOMBRE
     var APATERNO2 = ""; //DEMAS NOMBRES
     var APATERNO_LONGITUD = 0; //LONGITUD DE TODOS NOMBRES
     var APATERNO1_LONGITUD = 0; //LONGITUD DEL PRIMER NOMBRE(MAS UNO,EL QUE SOBRA ES UN ESPACIO EN BLANCO)
     var AMATERNO1 = ""; //PRIMER NOMBRE
     var AMATERNO2 = ""; //DEMAS NOMBRES
     var AMATERNO_LONGITUD = 0; //LONGITUD DE TODOS NOMBRES
     var AMATERNO1_LONGITUD = 0; //LONGITUD DEL PRIMER NOMBRE(MAS UNO,EL QUE SOBRA ES UN ESPACIO EN BLANCO)
     var VARLOOPS = 0; //VARIABLE PARA LOS LOOPS, SE INICIALIZA AL INICIR UN LOOP
     ...
     var estado  = regresaClaveEstado(pnuCveEntidad);
     pstCURP = pstCURP + splitAnio + splitMes + splitDia + pstSexo + estado
...
function ComparaCurpNombreApellidos(curp, nombre, paterno, materno)
{
     var año;
     fecha = curp.charAt(4) + curp.charAt(5) + "/" + curp.charAt(6) + curp.charAt(7) + "/" + curp.charAt(8) + curp.charAt(9);
     año = parseInt(curp.charAt(4) + curp.charAt(5));
     //NOTA: para quien revise esto en el año 2060, la validacion siguiente debe ser ajustada. CC 2018
     if (año < 60)
          fecha = "20" + fecha;
     else 
          fecha = "19" + fecha;
     curp2 = fnCalculaCURP(nombre, paterno, materno, fecha, curp.charAt(10), curp.charAt(11) + curp.charAt(12));
     if (curp !== curp2)
          return false;
     return true;
}
function regresaClaveEstado(estado)
{
     switch (estado) {
          case "0":
               estado = "--";
