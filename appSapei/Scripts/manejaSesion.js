...
; (function ($) {
    ...
    $(document).ajaxComplete(function (event, xhr, options) {
        ...
        if (respuesta === "" || respuesta === null || typeof respuesta === "undefined") {
        }
        else {
            ...
            if (separado[0] === "XD") {
            MensajesToastr("info", "Solicitud Procesada", separado[1]);
            $('#BodyPrincipal').load(separado[2]);
            }
