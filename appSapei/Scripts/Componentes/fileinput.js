...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
        removeClass: 'btn btn-dark btn-secondary',
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'archivo',
        filePlural: 'archivos',
        browseLabel: 'Inspeccionar',
        removeLabel: 'Eliminar',
        removeTitle: 'Eliminar archivos seleccionados',
        cancelLabel: 'Cancelar',
        cancelTitle: 'Abort ongoing upload',
        uploadLabel: 'Guardar',
        uploadTitle: 'Guardar datos capturados',
        msgNo: 'No',
        msgNoFilesSelected: 'No hay archivos seleccionados',
        msgCancelled: 'Cancelado',
        msgPlaceholder: 'Selecciona archivos',
        msgZoomModalHeading: 'Vista previa detallada',
        msgFileRequired: 'Debes seleccionar un archivo para guardar.',
        msgSizeTooSmall: 'El archivo "{name}" (<b>{size} KB</b>) es demasiado peque&ntilde;o y debe ser m&aacute;s grande que <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'El archivo "{name}" (<b>{size} KB</b>) excede el tama&ntilde;o de carga m&aacute;ximo permitido de <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debes seleccionar al menos <b>{n}</b> {archivo} paraa guardar.',
        msgFilesTooMany: 'El n&uacute;mero de archivos seleccionados para cargar  <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>.',
        ...
        msgInvalidFileExtension: 'Extensión no válida para el archivo"{name}". Solamente "{extensions}" se admiten archivos compatibles',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgAjaxError: 'Algo salió mal con la operación de carga de archivos por lotes. ¡Por favor, inténtelo de nuevo más tarde!',
        ...
        dropZoneTitle: 'Arrastra y suelta archivos aqui',
